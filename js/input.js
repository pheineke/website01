function sendData() {
    ...
    xhr.open("POST", "http://linda.rhrk.uni-kl.de:555555/new", true); // Hier wird die IP-Adresse und der Port des Servers angegeben
...
window.onload = function() {
    ...
    var xhr = new XMLHttpRequest();
    xhr.open("GET", "http://linda.rhrk.uni-kl.de:555555/history", true);
    xhr.onreadystatechange = function() {
        if (xhr.readyState === 4 && xhr.status === 200) {
            // Server response
            var response = JSON.parse(xhr.responseText);
